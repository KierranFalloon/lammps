This package contains a 2025 compatible LAMMPS implementation of the AWSEMMD model for protein folding and binding. The model is described in:
...
This implementation is based on the 2025 (stable_22Jul2025_update2) version of LAMMPS, and is not guaranteed to work with other versions. It is also not guaranteed to be bug-free, and is not yet supported by the LAMMPS developers. It is provided as-is, and is intended to be used as a starting point for further development.
