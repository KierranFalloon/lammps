...
#ifdef COMMAND_CLASS
// clang-format off
CommandStyle(temper/multi,TemperMulti);
// clang-format on
#else

#ifndef LMP_TEMPER_MULTI_H
#define LMP_TEMPER_MULTI_H

#include "command.h"

namespace LAMMPS_NS {

class TemperMulti : public Command {
 public:
  TemperMulti(class LAMMPS *);
  ~TemperMulti() override;
